...
const Cta = () => {
    ...
    whileInView="show"  className='text-white md:text-3xl text-2xl font-semibold md:text-left text-center'>Are you still facing confusion?
                ...
                <p className='text-white text-lg mt-4  md:text-left text-center'>Dr. Yogesh Jain, the best internal medicine specialist, is here to offer professional guidance for the optimal cure. Book a consultation now to gain clarity and embark on your journey to improved well-being with confidence.</p>
            </div>
